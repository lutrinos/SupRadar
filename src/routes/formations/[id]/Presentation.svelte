    ...
    <div class="card-body">
        ...
        <div class="stats">
            ...
            <div class="stat">
                ...
                <p class="stat-desc">Et { current.stats[IndiceStats.Acc_tot] } étudiants admis</p>
            </div>
            <div class="stat">
                ...
                <p class="stat-desc">Et {current?.stats[IndiceStats.nb_cla_PP]} candidats classés parmi {current?.stats[IndiceStats.voe_tot]}</p>
            </div>
        </div>
    </div>
</div>
